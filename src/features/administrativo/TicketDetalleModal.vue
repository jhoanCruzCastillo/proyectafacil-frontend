...
// la asesoría (o su cancelación) ya ocurrió. "completado" además ya no abre este modal — usa
// TicketDetalleCompletadoModal — así que en la práctica acá solo aplica a cancelado/observado/vencido.
